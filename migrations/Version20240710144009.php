 ...
 */
final class Version20240710144009 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE albums (id INT NOT NULL, artist VARCHAR(100) NOT NULL, title VARCHAR(100) NOT NULL, PRIMARY KEY(id))');
